  ...
  return (
    <div style={outerStyle}>
      <div style={innerStyle}>
        ...
        {showSelectionChrome ? (
          <div
            className="absolute bottom-0 right-0 size-3 bg-primary cursor-se-resize rounded-tl"
        ...
        {showSelectionChrome ? (
          <div className="absolute -top-9 left-1/2 -translate-x-1/2 flex items-center gap-0.5 bg-popover border border-border rounded-md shadow-md px-1 py-0.5 z-10">
            <AlignButton
